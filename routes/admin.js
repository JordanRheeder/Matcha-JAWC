...
//                 };
//                 ls.set('PP', filename);
//                 con.db.collection('user').findOneAndUpdate({ hash: req.session.user.hash }, { $set: { pp: filename } }); {
//                     if (err) throw(err);
//                 };
//                 resolve(fileInfo);
//             });
...
//         res.redirect('/login');
//         try {
//         await con.db.collection('user').findOne({ username: req.params.keys }, {pp: 1, firstname: 1}, (e, filename0) => {
//             if (e)
//             throw e;
